...
mit dem unten stehenden Link kannst du dich in unserer Bastelecke als Mitarbeiter registrieren.</div>*/
    ...
    html: '<div>Herzlich Wilkommen neuer Mitarbeiter!mit dem unten stehenden Link kannst du dich in unserer Bastelecke als Mitarbeiter registrieren</div></br>'+' <a href="http://projektwebshop.f4.htw-berlin.de:4200/registration/'+coder.code+'">registrieren</a>' // html body
        };
